...
sourceFiles = ['%s/pyretic/pyretic/sdx/examples/app_specific_peering_inboundTE/mininet/sdx_mininext.py' % os.environ[ 'HOME' ],
               '%s/pyretic/pyretic/pyresonance/resonance_states.py' % os.environ[ 'HOME' ],
               '%s/pyretic/pyretic/sdx/examples/app_specific_peering_inboundTE/mininet/quaggacfgs/a1/bgpd.conf' % os.environ[ 'HOME' ],
               '%s/pyretic/pyretic/sdx/examples/app_specific_peering_inboundTE/mininet/quaggacfgs/b1/bgpd.conf' % os.environ[ 'HOME' ],
               '%s/pyretic/pyretic/sdx/examples/app_specific_peering_inboundTE/mininet/quaggacfgs/c1/bgpd.conf' % os.environ[ 'HOME' ],
               '%s/pyretic/pyretic/sdx/examples/app_specific_peering_inboundTE/controller/participant_policies/participant_A.py' % os.environ[ 'HOME' ],
               '%s/pyretic/pyretic/sdx/examples/app_specific_peering_inboundTE/controller/participant_policies/participant_B.py' % os.environ[ 'HOME' ],
               '%s/pyretic/pyretic/sdx/examples/app_specific_peering_inboundTE/controller/participant_policies/participant_C.py' % os.environ[ 'HOME' ]]
