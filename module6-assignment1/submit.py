...
partFriendlyNames = ['Create a fully functional layer-2 Firewall application using Pyretic'] 
# source files to collect (just for our records)
sourceFiles = ['%s/pyretic/pyretic/examples/pyretic_firewall.py' % os.environ[ 'HOME' ] ]                   
